...
import com.holonplatform.datastore.mongo.spring.internal.MongoSyncDatastoreRegistrar;
...
/**
 * Annotation to be used on Spring Configuration classes to setup a synchronous MongoDB {@link Datastore}.
 *
 * @since 5.2.0
 */
...
@Documented
@Inherited
@Import(MongoSyncDatastoreRegistrar.class)
@EnableDatastoreConfiguration
public @interface EnableMongoDatastore {

	/**
	 * Default Datastore registration bean name.
	 */
	public static final String DEFAULT_DATASTORE_BEAN_NAME = "mongoSyncDatastore";
