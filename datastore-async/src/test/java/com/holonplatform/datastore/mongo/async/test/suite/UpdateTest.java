...
public class UpdateTest extends AbstractDatastoreOperationTest {
	...
	public void testUpdate() {
		...
		value = PropertyBox.builder(SET1).set(ID, oid).set(STR, TestValues.U_STR).set(STR2, TestValues.U_STR2)
		...
		result = getDatastore().update(TARGET, value).toCompletableFuture().join();
	...
	public void testUpdateMissingId() {
		...
		getDatastore().update(TARGET, value).toCompletableFuture().join();
