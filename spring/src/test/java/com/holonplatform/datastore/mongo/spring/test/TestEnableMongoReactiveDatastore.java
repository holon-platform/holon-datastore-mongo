...
@ContextConfiguration(classes = TestEnableMongoReactiveDatastore.Config.class)
public class TestEnableMongoReactiveDatastore extends AbstractMongoDBSpringTest {
	...
	@Autowired
	private ReactiveMongoDatastore datastore;
