 ...
 * @since 5.2.0
 */
public class SyncAggregateOperationConfigurator implements AggregateOperationConfigurator {

	private final AggregateIterable<?> iterable;

	public SyncAggregateOperationConfigurator(AggregateIterable<?> iterable) {
		super();
