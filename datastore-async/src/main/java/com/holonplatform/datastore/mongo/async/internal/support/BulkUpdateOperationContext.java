...
/**
 * Bulk update operation context.
 *
 * @since 5.2.0
 */
public interface BulkUpdateOperationContext extends BulkOperationContext {

	/**
	 * Get the operation coniguration.
	 * @return Operation coniguration
	 */
	BulkUpdateOperationConfiguration getOperationConfiguration();

	static BulkUpdateOperationContext create(MongoOperationContext<MongoDatabase> operationContext,
		...
		return new DefaultBulkUpdateOperationContext(operationContext, configuration, resolutionContext, collection,
				filter, operationConfiguration);
	}
