...
/**
 * Default {@link MongoPropertySetSerializationTreeResolver} implementation.
 *
 * @since 5.2.0
 */
public enum DefaultMongoPropertySetSerializationTreeResolver implements MongoPropertySetSerializationTreeResolver {
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.mongo.core.document.MongoPropertySetSerializationTreeResolver#resolve(com.
