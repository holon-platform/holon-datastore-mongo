 ...
 * the License.
 */
package com.holonplatform.datastore.mongo.core.resolver;
 ...
 * <p>
 * If the {@link ResolutionContext} is not a {@link MongoResolutionContext} an exception is thrown.
 * </p>
 * 
 ...
 * @since 5.2.0
 */
public interface MongoExpressionResolver<E extends Expression, R extends Expression> extends ExpressionResolver<E, R> {
	 ...
	 * @param context Resolution context as a {@link MongoResolutionContext}
