...
/**
 * Registrar for MongoDB {@link Datastore} beans registration.
 * 
 * @since 5.0.0
 */
public class MongoSyncDatastoreAutoConfigurationRegistrar
	...
	public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry registry) {
		if (beanFactory instanceof ListableBeanFactory) {
			for (String[] mongoClientDefinition : BeanRegistryUtils.getBeanNamesWithDataContextId(registry,
				...
				MongoSyncDatastoreRegistrar.registerSyncDatastore(registry, environment, dataContextId,
